...
class Polygon() :
    def __init__(self, ring):
        ...
        if self.ring[0] != self.ring[-1]:  # 如果ring的第一个元素和最后一个元素不相等
            self.ring.CloseRings()  # 用CloseRings闭合Ring，
            self.polygon.AddGeometry(ring)  # 把环 ring添加到  polygon
...
if __name__ =='__main__':
    ring = [ [108.920221,34.229893], [108.919324,34.228498],
