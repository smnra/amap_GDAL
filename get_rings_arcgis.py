...
class GetArcgisObgect():
    ...
    def extractRingInfo(self,resultJson):
        ...
        ring = [None]*6
        ring[0] = resultJson['results'][0]['attributes']['OBJECTID']
        ring[1] = resultJson['results'][0]['attributes']['Shape']
        ring[2] = resultJson['results'][0]['attributes']['Shape_Length']
...
if __name__ == '__main__' :
    ...
    for i in range(2000,964729):
        resultJson = arcgisObject.getRingJson(i)
        arcgisObject.extractRingInfo(resultJson)
